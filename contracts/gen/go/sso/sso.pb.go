...
type LoginResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"` // Auth token to the logged in user
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_sso_sso_proto_rawDesc = string([]byte{
	...
	0x5a, 0x14, 0x6d, 0x61, 0x74, 0x74, 0x68, 0x65, 0x77, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31,
